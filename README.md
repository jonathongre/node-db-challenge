...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      ...
      `Relational Databases are databases based on the relational model of data (as opposed to NoSQL which has a collections/documents). SQL is the language used to query said database.`

- [ ] Why do tables need a `primary key`?

      `A primary key is the unique identifier for a data entry.`
